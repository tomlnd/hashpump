...
public:
  ...
  vector<unsigned char> *GenerateStretchedData(vector<unsigned char> originalMessage, int keylength, unsigned char *hash, vector<unsigned char> added, vector<unsigned char> postfix, unsigned char **newSig);
};
